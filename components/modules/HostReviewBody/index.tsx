                ...
                <Box className={classes.InnerfirstDiv}>
                        ...
                        <Box className={classes.AltitudeText}>
                            ...
                            <Box className={classes.dflexRow+" "+classes.marginBottom}>
                                ...
                                <Box className={classes.dColumn+ " " + classes.LeftMargin10}>
                                    <Typography variant="caption" className={classes.grayColor}>Guest</Typography>
                                    <Typography variant="caption" className={classes.topMargin5}>Cynthia Johnson</Typography>
                                </Box>
                            </Box>
                        </Box>
                    ...
                    <Box className={classes.MainRating}>
                        <Box className={classes.dColumn+" "+ classes.topMargin15}>
                            ...
                            <Typography variant="caption"> Did the guest left the property in order? </Typography>
                        </Box>
                    ...
                    <Box className={classes.MainRating}>
                        <Box className={classes.dColumn+" "+ classes.topMargin15}>
                            ...
                            <Typography variant="caption"> How was the communication between you and the guest? </Typography>
                        </Box>
                        <Box className={classes.dflexRow+" "+classes.topMargin15}>
                        <StarIcon className={classes.LeftMargin10} style={{color: "#D7DDEA", marginRight :"5px"}}/>
                        <StarIcon className={classes.LeftMargin10} style={{color: "#D7DDEA", marginRight :"5px"}}/>
                    ...
                    <Box className={classes.MainRating}>
                        <Box className={classes.dColumn+" "+ classes.topMargin15}>
                            ...
                            <Typography variant="caption"> Did the guest respected the rules you had put in place? </Typography>
                        </Box>
                        <Box className={classes.dflexRow+" "+classes.topMargin15}>
                        <StarIcon className={classes.LeftMargin10} style={{color: "#D7DDEA", marginRight :"5px"}}/>
                        <StarIcon className={classes.LeftMargin10} style={{color: "#D7DDEA", marginRight :"5px"}}/>
